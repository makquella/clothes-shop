...
export function Marquee() {
  ...
  return (
    <div className="w-[110vw] -ml-[5vw] overflow-hidden whitespace-nowrap bg-white text-black font-display font-black py-3 my-8 transform -rotate-3 scale-105 border-y-4 border-black z-20 relative mix-blend-screen isolate">
